          ...
          appBar: AppBar(
            ...
            actions: [
              TextButton(
                ...
                onPressed: () {
                  print('id search $id');
                  print('id search $name');
                  print('id search $mobile');
                  print('id search $name');
                  // if (!(id == null || name == '')) {
                  // MotionToast.error(
                  //   title: const Text("Error"),
                  //   description: const Text("You Must Select Sender!"),
                  // ).show(context);
                  // } else {
                  //   print('else');
                  Navigator.pop(context, [id, name, mobile]);
                  // }
                },
              ),
            ],
                  ...
                  Padding(
                    ...
                    child: TextField(
                      onChanged: (value) {
                        ...
                        print('texttt :${_searchController.text} ');
                      },
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          name = senderProvidr.getSenders.data![catogrey]?[i].first[
              senderProvidr.getSenders.data![catogrey]?[i].first.keys.first];
          mobile = senderProvidr.getSenders.data![catogrey]?[i].last[
              senderProvidr.getSenders.data![catogrey]?[i].first.keys.first];
        },
        child: Container(
          color: Colors.transparent,
